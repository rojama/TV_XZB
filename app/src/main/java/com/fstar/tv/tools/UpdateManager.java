...
//                    Toast.makeText(mContext, R.string.soft_update_no, Toast.LENGTH_SHORT).show();
    ...
    public boolean isUpdate() {
        ...
        try {
            ...
            //InputStream inStream = ParseXmlService.class.getClassLoader().getResourceAsStream(Config.updateUrl);
            URL url = new URL(Config.updateUrl);
